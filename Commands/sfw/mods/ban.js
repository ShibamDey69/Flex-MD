  ...
  run: async (
    ...
    try {
          ...
          if (!quoted && !senderRegex.test(args)) {
            ...
            if (args.length > 5) {
              ...
              return m.reply(
                "edit",
                nul,
                `${Group.name} *_Group has been Banned from using this bot for this reason_* \n\n *_Reason:_* ${args}`,
              );
            }
            ...
            return m.reply(
              "edit",
              nul,
              `${Group.name} *_Group has been Banned from using this bot..!!_*`,
            );
          }
        }
      }
      ...
      if (
        ...
        let mnton = senderRegex.test(args)
